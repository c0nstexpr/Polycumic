...
static_assert(concepts::same_as<my_type_list::indexed_t<1>, char>);
static_assert(my_type_list::contains<double>);
static_assert(my_type_list::count<char> == 2);
static_assert(my_type_list::find<int> == 0);
static_assert(concepts::same_as<traits::empty_type_list::rest_t, traits::empty_type_list>);
